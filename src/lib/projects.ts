...
export const PROJECTS: Record<string, ProjectCaseStudy> = {
  warrantyos: {
    ...
    pageMeta: {
      ...
      duration: "Live · 2026",
      year: "2026",
      role: "Founder · Product, design & delivery",
    },
    heroImage: "/assets/warrantyos-hero.png",
    heroImageAlt: "WarrantyOS dealer onboarding workflow shown on a laptop in a showroom",
    heroImagePosition: "center center",
    heroCaption: ["WarrantyOS, 2026", "CRM, dealer portal, and claims operations in sync"],
    detailImages: [
      { src: "/assets/warrantyos-body-crm.png", alt: "WarrantyOS CRM dashboard showing dealer opportunities, pipeline value, and account activity" },
      { src: "/assets/warrantyos-body-workflow.png", alt: "WarrantyOS onboarding workflow showing tasks, progress, and operational alerts" },
    ],
    challenge: {
      h: "The problem was not technology. The problem was visibility.",
      p: "Running the warranty business exposed the gap quickly. Sales knew the deal. Dealers knew what they had sold. Claims handlers knew the risk. Finance knew the money. Leadership had to piece it all together afterwards. Forecasts, product terms, dealer performance, fund balances, invoices, commissions, customer claims, phone calls, emails, and support notes were all connected in real life, but not in the software.",
    },
    solution: {
      h: "So I built three products that behave like one system.",
      p: "WarrantyOS is a staff CRM, a dealer portal, and a claims support app working together. The CRM runs the commercial lifecycle: prospects, products, pricing, forecasts, contracts, invoices, commissions, dealer health, and performance. The dealer portal gives dealers the self-service layer for warranty sales and claims. The support app turns email, Aircall, public form, and manual claim intake into structured workflows, AI-assisted assessments, decisions, communications, and audit trails.",
    },
    stack: [
      { k: "Product estate", v: ["WarrantyOS CRM", "Dealer Portal", "Claims Scanner"] },
      { k: "CRM backbone", v: ["Dealer lifecycle", "Product templates", "Forecast pacing", "Invoices", "Commission snapshots"] },
      { k: "Dealer layer", v: ["Warranty registration", "Claim submission", "Product availability", "Fund visibility", "Reporting"] },
      { k: "Claims layer", v: ["Email intake", "Aircall intake", "Public form", "Manual entry", "AI assessment"] },
      { k: "Sync model", v: ["Internal APIs", "PortalOutbox events", "Shared product keys", "Dealer-linked claims", "Audit history"] },
    ],
    process: [
      { n: "Found the fracture", d: "The same dealer could appear in sales, support, finance, and claims without one clear operating record. That made simple questions expensive: what did we sell, what is at risk, what is owed, what changed, and who acted last?" },
      { n: "Built the commercial source of truth", d: "The CRM became the place where the business is configured: dealer records, contacts, opportunities, product templates, per-dealer pricing, forecasts, signed plans, invoice flows, commissions, reports, and dealer health." },
      { n: "Gave dealers their own surface", d: "The portal keeps dealer-facing work out of inboxes. Dealers can use the operating layer without seeing internal commercial controls, while the business still keeps the data connected." },
      { n: "Turned claims into an operation", d: "The support app captures claims from four channels, links them to dealers, structures evidence, runs decision support, drafts communications, records activity, and keeps handlers focused on the next action." },
      { n: "Joined the estate together", d: "The important part is the sync. CRM terms inform portal behaviour. Portal activity informs commercial reporting. Claims activity links back to dealer performance. Everyone works from the same truth instead of rebuilding it." },
    ],
    result: {
      h: "WarrantyOS gives the business one transparent operating picture.",
      p: "Sales can see whether a dealer is moving from promise to performance. Account managers can see pacing and risk before month end. Finance can issue invoices and track commissions against the same source data. Claims handlers can see the dealer context before making a decision. Leadership can understand activity, exposure, and performance without chasing five versions of the truth.",
    },
    metrics: [
      { n: "3", l: "Connected products" },
      { n: "4", l: "Claim intake channels" },
      { n: "5", l: "Decision states" },
      { n: "14+", l: "CRM operating modules" },
    ],
    commercialsCopy:
      "The revolutionary part is not the stack. It is the deliverable. WarrantyOS takes a messy, multi-sided warranty operation and gives each team the screen they need while keeping the business logic underneath connected. That means fewer blind spots, cleaner handovers, stronger auditability, and faster decisions across the whole company.",
    comm: {
      model: "B2B2C warranty operating system",
      status: "Live",
      revenue: "Dealer network + warranty operations",
      ownership: "Founder · product lead",
    },
    quote: "One business. Three specialist products. One live version of the truth.",
    attr: { name: "WarrantyOS", role: "Operating thesis" },
  },
  ...
  govscape: {
    ...
    comm: {
      ...
      status: "Live",
      revenue: "Discovery engagement · remediation programme · managed retainer",
  ...
  wilbolaw: {
    ...
    coverFit: "cover",
    coverPosition: "center center",
    cta: { label: "Live preview", href: "https://wilbolaw.com" },
    pageMeta: {
